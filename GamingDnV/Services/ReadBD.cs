        ...
        public static ObservableCollection<UsersModel> ReadUsersInDb(string sql)
        {
            ...
            while (reader.Read())
            {
                Users.Add(new UsersModel()
                {
                    ...
                    UserName = Convert.ToString(reader[2].ToString()),
                    ...
                    Species = Convert.ToString(reader[12].ToString()),
                    Class = Convert.ToString(reader[13].ToString()),
                    ...
                    Passiv = Convert.ToInt32(reader[22].ToString())
                });
            }
            myConnect.Close();
            return Users;
